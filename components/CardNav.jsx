        ...
        <div
          ...
          <div
            ...
            {typeof logo === 'string' ? (
              ...
              logo // React node (text/logo component) render hoga
            )}
          </div>

          {/* Sirf ye use karo, outer button hata do */}
          <ReadCvModal buttonBgColor="#111" buttonTextColor="#fff" />
              ...
              <div className="nav-card-links mt-auto flex flex-col gap-[2px]">
                {item.links?.map((lnk, i) => (
                  <a
                    ...
                    <GoArrowUpRight className="nav-card-link-icon bg-cyan-50 shrink-0" aria-hidden="true" />
                    {lnk.label}
                  </a>
                ))}
              </div>
